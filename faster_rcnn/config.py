...
class _ConfigTUPUFace:
    # Dataset config
    input_json_files = [
            "/world/data-gpu-112/zhanglinghan/TUPU-FACE-DETECT-DATASET/data_train.json",
            "/world/data-gpu-112/zhanglinghan/TUPU-FACE-DETECT-DATASET/15257540018230.7161486853115395_list.json"
            ]
    resize_short_size = 600
    ...
    bbox_count_before_nms = 2000
    rpn_nms_thresh = 0.7
    test_dataset_json_lst = [
            "/world/data-gpu-112/zhanglinghan/TUPU-FACE-DETECT-DATASET/wh9_16_shuffle_test.json"
            ]
